...
\textbf{Conventions}\\
We are given a simply connected bounded domain $\Omega$ with boundary $\Gamma$ in the complex plane $\C$. The task is to find an angle-preserving mapping $\psi$ from the unit disk $\disk$ to $\Omega$. 
