...
\color{red} 
In higher dimensions, slmcoawrown
\color{black}
...
\begin{theorem}[Riemann Mapping Theorem]
    If $U$ is a non-empty simply connected open subset of the complex number plane $\mathbb{C}$ which is not all of $\mathbb{C}$, then there exists a biholomorphic mapping $f$ (i.e. a bijective holomorphic mapping whose inverse is also holomorphic) from $U$ onto the open unit disk
    $$ D = \{z \in \mathbb{C}: |z|<1 \}. $$
