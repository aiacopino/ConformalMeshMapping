\begin{sidewaystable}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{} 
        >{\hsize=0.8\hsize\raggedright\arraybackslash}X  % 1. Method (Narrow)
        >{\hsize=0.5\hsize\raggedright\arraybackslash}X  % 2. Shape (Very Narrow)
    ...
    @{}}
        ...
        Analytic Interpolating Polynomial for Boundary Corresp. Fct& 
        Efficient point evaluation; Robust (less dependent than Wegmann's on initial guess). & 
        Linear (slow) convergence; Requires smooth boundary; Approximative Solution (inaccurate). \\
        \addlinespace
        ...
        Fourier Series of $\eta$ & 
        Analytic Interpolating Polynomial for Boundary Corresp. Fct & 
        Quadratic (fast) convergence; High accuracy (FFT); Efficient point evaluation. & 
