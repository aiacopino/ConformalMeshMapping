...
\begin{abstract}
    When performing shape optimization one encounters the problem of conformal mapping of a relatively simple onto a potentially very complicated (simply connected) domain. The Riemann mapping theorem guarantees the existence of such a conformal map, but does not provide any explicit construction of it. In practice, one has to resort to numerical methods to construct an approximation of the conformal map.
