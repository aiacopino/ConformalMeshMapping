...
The above equation (\ref{eq:h_k+1}) is a Riemann-Hilbert Problem \cite{AnosovBolibruch1994_riemannhilbertproblems} of two unknowns, $U_k$ and $\psi_{k+1}$.
...
\cite{Muskhelishvili1977} plemelj formulas (definition of M)
